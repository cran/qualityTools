setClass(Class = "mixDesign", representation = representation(name = "character", factors = "list", 
    ...
    response = "data.frame", Type = "data.frame", block = "data.frame", runOrder = "data.frame", 
    standardOrder = "data.frame", desireVal = "list", desirability = "list", fits = "data.frame"))
...
.simplexCentroid(4)
mixDesign = function(p, n = 3, type = "lattice", center = TRUE, axial = FALSE, delta, 
